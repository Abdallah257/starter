                ...
                <div class="featured">
                    @foreach($latestArticles as $article)
                        ...
                        <div class="featured__column featured__column--small">
                            ...
                            <div class="entry" style="background-image:url('{{$article->image}}');">

                                <div class="entry__content">
                                    <span class="entry__category"><a href="#0">{{$article->categories[0]->name ??''}}</a></span>

                                    <h1><a href="#0" title="">{{$article->title}}.</a></h1>

                                    <div class="entry__info">
                                        <a href="#0" class="entry__profile-pic">
                                            <img class="avatar" src="{{$article->employee->image}}" alt="">
                                        </a>

                                        <ul class="entry__meta">
                                            <li><a href="#0">{{$article->employee->name}}</a></li>
                    ...
                    <div class="entry__thumb">
                        <a href="single-audio.html" class="entry__thumb-link">
                            <img src="assets/images/thumbs/masonry/guitarman-400.jpg"
                                 srcset="assets/images/thumbs/masonry/guitarman-400.jpg 1x, images/thumbs/masonry/guitarman-800.jpg 2x" alt="">
                        </a>
